package org.apache.flink.streaming.api.scala.ml.classifiers.trees

import breeze.linalg.argmax

import scala.math.{sqrt, log => math_log}
import scala.collection.mutable.Queue
import org.apache.flink.streaming.api.scala.ml.utils.Logging
import com.github.javacliparser._
import org.apache.flink.streaming.api.scala.ml.utils.Utils.{argmax, normal}
import org.apache.flink.streaming.api.scala.ml.core._
import org.apache.flink.streaming.api.scala.ml.classifiers._
import org.apache.flink.streaming.api.scala.ml.classifiers.trees.nodes._
import org.apache.flink.streaming.api.scala.ml.core.specification.ExampleSpecification
 ...
 * </ul>
 */
class HoeffdingTree extends Classifier with Serializable {
   ...
   * @return Unit
   */
  override def train(input: DataStream[Example]): Unit = {
    input.flatMap{
